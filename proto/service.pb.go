...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b58d2f7072a9d833, []int{0}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b58d2f7072a9d833, []int{1}
}
...
func (*Connect) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b58d2f7072a9d833, []int{2}
}
...
func (*Close) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b58d2f7072a9d833, []int{3}
}
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_b58d2f7072a9d833) }

var fileDescriptor_service_b58d2f7072a9d833 = []byte{
